...
def lectura(URL):
    ...
    #al parecer tengo un error con el archivo 01, cuando es el mas grande no los puede procesar por lo que necesito tratarlos para que puedean ser manejados 
...
def main():
    ...
    theta_opt,costo, iteraciones, trayectoria, performance= trainGDX(A,Y_normalized,paramIniciales,1000000,10000)
    ...
    _,_,_,RMSE = funcion_costo(Y_normalized,Y_hat,theta_opt)
